"""
Helps to analyze the logs for rerouted orders 
1. checks the server logs for rerouted orders
2. collects rerouted order ids
3. collects rtt values from the trader logs
"""
