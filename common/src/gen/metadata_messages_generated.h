...
#ifndef FLATBUFFERS_GENERATED_METADATAMESSAGES_HFT_SERIALIZATION_GEN_FBS_METADATA_H_
#define FLATBUFFERS_GENERATED_METADATAMESSAGES_HFT_SERIALIZATION_GEN_FBS_METADATA_H_
...
inline flatbuffers::Offset<OrderTimestamp> CreateOrderTimestamp(flatbuffers::FlatBufferBuilder &_fbb, const OrderTimestampT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return hft::serialization::gen::fbs::metadata::CreateOrderTimestamp(
      _fbb,
      _order_id,
      _created,
      _fulfilled,
...
inline const hft::serialization::gen::fbs::metadata::OrderTimestamp *GetOrderTimestamp(const void *buf) {
  return flatbuffers::GetRoot<hft::serialization::gen::fbs::metadata::OrderTimestamp>(buf);
}

inline const hft::serialization::gen::fbs::metadata::OrderTimestamp *GetSizePrefixedOrderTimestamp(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<hft::serialization::gen::fbs::metadata::OrderTimestamp>(buf);
}

inline bool VerifyOrderTimestampBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<hft::serialization::gen::fbs::metadata::OrderTimestamp>(nullptr);
}

inline bool VerifySizePrefixedOrderTimestampBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<hft::serialization::gen::fbs::metadata::OrderTimestamp>(nullptr);
}

inline void FinishOrderTimestampBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<hft::serialization::gen::fbs::metadata::OrderTimestamp> root) {
  fbb.Finish(root);
}
...
inline std::unique_ptr<hft::serialization::gen::fbs::metadata::OrderTimestampT> UnPackOrderTimestamp(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<hft::serialization::gen::fbs::metadata::OrderTimestampT>(GetOrderTimestamp(buf)->UnPack(res));
}

inline std::unique_ptr<hft::serialization::gen::fbs::metadata::OrderTimestampT> UnPackSizePrefixedOrderTimestamp(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<hft::serialization::gen::fbs::metadata::OrderTimestampT>(GetSizePrefixedOrderTimestamp(buf)->UnPack(res));
}
...
#endif  // FLATBUFFERS_GENERATED_METADATAMESSAGES_HFT_SERIALIZATION_GEN_FBS_METADATA_H_
